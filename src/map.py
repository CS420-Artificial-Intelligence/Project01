    ...
    def draw(self, screen):
        for i in range(len(self.matrix)):
            for j in range(len(self.matrix[i])):
                if self.matrix[i][j] == "#":
                    self.wall_block.changePosition(j * self.block_size, i * self.block_size)
                    self.wall_block.draw(screen)
                if self.matrix[i][j] == ".":
                    self.switch_block.changePosition(j * self.block_size, i * self.block_size)
                    self.switch_block.draw(screen)
                if self.matrix[i][j] == "*":
                    self.switch_block.changePosition(j * self.block_size, i * self.block_size)
                    self.switch_block.draw(screen)
                    self.stone_entity.changePosition(j * self.block_size, i * self.block_size)
                    self.stone_entity.draw(screen)
                if self.matrix[i][j] == "+":
                    self.switch_block.changePosition(j * self.block_size, i * self.block_size)
                    self.switch_block.draw(screen)
                    self.ares_entity.changePosition(j * self.block_size, i * self.block_size)
                    self.ares_entity.draw(screen)
                if self.matrix[i][j] == " ":
                    self.nonwall_block.changePosition(j * self.block_size, i * self.block_size)
